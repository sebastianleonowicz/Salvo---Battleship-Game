...
//        dto.put("isItGameOver", isItGameOver(gamePlayer)); // checks if it's GameOver
        dto.put("canFireSalvoes", canFireSalvoes(gamePlayer)); // checks if GP can fire salvo
            ...
            //            dto.put("canIShoot", canIShoot(gamePlayer) );
...
//
    ...
    Long turn = getCurrentTurn(gamePlayer);
    if((gamePlayer.getShipsLeftOnTurn(gamePlayer, turn).get() == 0 && gamePlayer.getOtherGamePlayer(gamePlayer).getShipsLeftOnTurn(gamePlayer, turn).get() != 0) && gamePlayer.areShipsPlaced(gamePlayer) == true){
...
//        Long turn = getCurrentTurn(gamePlayer);
//        if((gamePlayer.getShipsLeftOnTurn(gamePlayer, turn).get() == 0) && gamePlayer.areShipsPlaced(gamePlayer) == true
//                || gamePlayer.getOtherGamePlayer(gamePlayer.getShipsLeftOnTurn(gamePlayer.getOtherGamePlayer(gamePlayer).))){
//           return true;
//        }else{
//            return false;
//        }
